...
class supplierClass:
    def __init__(self,root):
        ...
        Text_search=Entry(self.root,textvariable=self.var_searchtxt,font=("goudy old style",15),bg="lightyellow").place(x=800,y=80,width=160)
        Button_search=Button(self.root,text="Search",command=self.search,font=("goudy old style",15),bg="green",fg="white",cursor="hand2").place(x=980,y=79,width=100,height=28)

        #====title======
        title=Label(self.root,text="Supplier Details",font=("goudy old style",20,"bold"),bg="darkblue",fg="white").place(x=50,y=10,width=1000,height=40)
